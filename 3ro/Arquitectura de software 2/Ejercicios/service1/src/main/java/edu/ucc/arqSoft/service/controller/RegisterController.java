...
public class RegisterController {
	...
	public @ResponseBody ResponseEntity<Object> lookupMeditionsBySensorId(@PathVariable("ID") Long id) {

			List<RegisterResponseDto> dtos = registerService.getMeditions(id);
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	    public @ResponseBody RegisterResponseDto registrar(@RequestBody RegisterRequestDto request) {
		return registerService.registrar(request);
